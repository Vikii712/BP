...
<head>
    ...
    <title>VOTUM - Ako nás podporiť?</title>
        ...
        <div class="container mx-auto px-4 py-4">
            ...
            <nav>
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="support.html" class="flex items-center gap-4 py-3 px-4 bg-white bg-opacity-10 rounded-lg transition" onclick="toggleMobileMenu()">
