...
@section('adminContent')
    <div class="min-h-[calc(100vh-5.5rem)] pt-20 bg-gray-100 px-4 py-10">
        <div class="max-w-6xl mx-auto space-y-10">
            ...
            @if(session('success'))
                <div
                    class="bg-green-100 border-2 border-green-600 text-green-800 px-6 py-4 rounded-lg flex items-center justify-between">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid lg:grid-cols-2 gap-6" id="documentsWrapper">
                                @foreach($section->documents as $docIndex => $document)
                                    <div
                                        class="border-2 border-votum3 rounded-lg bg-votum3 shadow-sm overflow-hidden document">
                                        <div class="bg-dark-votum3 flex items-center justify-between px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                <span class="text-white px-3 py-1 rounded-md text-sm font-bold"
                                        ...
                                        <div class="bg-white p-4 space-y-4">
                                            <input type="hidden" name="documents[{{ $docIndex }}][id]"
                                                   value="{{ $document->id }}">
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-1">SK –
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-1">EN –
                                                        Názov dokumentu:</label>
                                                    <input type="text"
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-2">Súbor
                                                    dokumentu:</label>
                                                ...
                                                <div class="flex gap-3 items-center">
                                                    ...
                                                    <label
                                                        class="px-4 py-2 border-2 border-votum3 text-votum3  rounded-md cursor-pointer hover:opacity-90 transition-opacity">
                                                        Nahradiť
                                                        <input type="file"
