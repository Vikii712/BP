                    ...
                    <table class="min-w-full">
                        ...
                        @forelse($events as $event)
                            <tr class="border-t hover:bg-blue-50">
                                ...
                                <td class="px-4 py-4 text-center">
                                    <button
                                        onclick="openDeleteModal('Udalosť: {{ addslashes($event->title_sk) }}', '{{ route('events.destroy', $event->id) }}')"
            ...
            @if($events->lastPage() > 1)
                <div class="flex items-center justify-center gap-2 pb-4">
                    ...
                    @if($events->onFirstPage())
                        <span
                            class="px-4 py-2 rounded-md bg-gray-200 text-gray-400 font-semibold cursor-not-allowed select-none">
                            ← Predchádzajúca
                        </span>
                    @else
