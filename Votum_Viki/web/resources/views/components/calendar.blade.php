        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    <button id="prevMonth" class="bg-votum-blue text-white px-3 py-1 rounded hover-scale">
                        <i class="fas fa-chevron-left"></i>
                    </button>
                    <h3 id="currentMonth" class="text-xl font-bold text-votum-blue"></h3>
                    <button id="nextMonth" class="bg-votum-blue text-white px-3 py-1 rounded hover-scale">
