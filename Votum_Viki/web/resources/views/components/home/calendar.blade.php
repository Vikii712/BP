...
<script>
    ...
    function generateEventsList() {
        ...
        sortedEvents.forEach(event => {
            ...
            eventDiv.className = `
                bg-votum2 p-4 rounded-lg flex flex-col sm:flex-row
                justify-between items-center sm:items-center
                gap-4 border-4 border-votum2 text-center sm:text-left
            `;

                        eventDiv.innerHTML = `
                <div class="w-full sm:w-auto">
                    <h4 class="font-bold text-votum-blue h3">
                        ${eventDate.getDate()}.${eventDate.getMonth() + 1}. ${event.title}
                    </h4>
                </div>

                <a href="{{route('event')}}"
                   class="txt-btn rounded-xl bg-white text-votum-blue border-3 border-votum2
