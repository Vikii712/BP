                    ...
                    <div class="flex flex-col lg:flex-row items-start gap-6 text-lg text-gray-800 leading-relaxed">
                        ...
                        <div class="flex-1 txt">
                            <div class="flex items-center gap-4 pb-3">
                                ...
                                <h2 class="h3 sentence font-bold text-votum-blue">{{ $qrHow['title'] }}</h2>
                            </div>
                            <div class="divide-highlight">{!! $qrHow['content']  !!}</div>
                        </div>
            ...
            <div class="border-4 border-votum1 bg-blue-100 p-2 sm:p-6 rounded-lg shadow-lg self-center">
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex items-center gap-4 flex-wrap">
                        ...
                        <h2 class="h3 font-bold sentence text-votum-blue">{{ __('nav.bank') }}</h2>
                    </div>

                    <!-- Údaje -->
                    <div class="space-y-3 break-all sm:break-normal">
                        @foreach($bank as $banka)
                            <x-front::contacts.input name="{{$banka['title']}}" value="{{$banka['content']}}" color="1"/>
                        @endforeach
                    </div>
                </div>
            </div>
