        ...
        <div class="relative max-w-4xl mx-auto md:pl-20">            <!-- Vertikálna čiara -->
            ...
            @foreach($timeline as $i =>  $entry)
                <div class="relative mb-12 last:mb-0">
                    <!-- Bodka -->
                    <div
                        class="absolute left-[1px] top-3 w-4 h-4 rounded-full bg-white border-4 border-votum-blue shadow"></div>
           ...
           md:absolute md:right-[calc(100%+1rem)] md:ml-0 whitespace-nowrap">
                    ...
                    <div class="ml-8 pt-5 md:p-6 relative">
                        ...
                        <x-front::listen :text="$entry['year'] . $entry['name'] . '. ' . $entry['text']" id="{{100 + $i}}"/>
