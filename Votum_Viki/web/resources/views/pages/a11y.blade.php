...
@section('content')
    <section class="max-w-4xl mx-auto py-12 px-6 txt">
        ...
        <p class="mb-4">
            V <strong>Združení VOTUM</strong> sa snažíme, aby bola táto webová stránka prístupná a použiteľná pre čo najširšie spektrum ľudí — vrátane osôb so zrakovým, sluchovým, motorickým alebo kognitívnym znevýhodnením.
        ...
        <p class="mb-4">
            Web je navrhnutý v súlade s odporúčaniami <strong>WCAG 2.1 (Web Content Accessibility Guidelines)</strong> na úrovni <strong>AA</strong>, pričom sa snažíme niektoré prvky implementovať aj na úrovni <strong>AAA</strong>, ak je to technicky a obsahovo možné.
        </p>
        ...
        <p class="mb-4">
            ...
            Externý obsah (napr. videá alebo mapy) sa načítava až po interakcii používateľa, aby sa predišlo nečakanému správaniu alebo zníženiu prístupnosti.
        </p>

        <h2 class="h3 font-semibold mt-6 mb-2">Známe obmedzenia</h2>
        <p class="mb-4">
            Napriek našej snahe môžu niektoré časti stránky ešte nespĺňať všetky požiadavky štandardu WCAG 2.1. Aktuálne evidujeme najmä:
        </p>
        ...
        <p class="mb-4">
            Ak narazíte na problém s prístupnosťou alebo potrebujete obsah v alternatívnej forme (napr. jednoduchší text, väčšie písmo alebo prepis), radi vám pomôžeme.
        </p>
        ...
        <p class="mb-4">
            Pri nahlasovaní problému prosím uveďte čo najviac informácií — konkrétnu stránku, popis problému a ideálne aj zariadenie alebo prehliadač, ktorý používate.
        </p>
