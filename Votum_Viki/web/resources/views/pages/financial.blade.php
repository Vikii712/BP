...
@section('content')
                ...
                <div class="flex flex-col lg:flex-row items-start gap-6 text-lg text-gray-800 leading-relaxed">
                    ...
                    <div class="flex-1 txt">
                        <div class="flex items-center gap-4 pb-3">
                            ...
                            <h2 class="h3 font-bold text-votum-blue">QR kód:</h2>
                        </div>
            ...
            <div class="border-4 border-votum1 bg-blue-100 p-6 rounded-lg shadow-lg self-center">
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <h2 class="h3 font-bold text-votum-blue">Bankové údaje:</h2>
                    </div>
    ...
    <div class="bg-blue-100">
        <section class="max-w-4xl mx-auto mb-12 text-center py-10 px-4">
            ...
            <h2 class="h3 font-bold mb-4 text-votum-blue">Ďakujeme za vašu podporu!</h2>
            <p class="txt text-gray-800">Každý príspevok, bez ohľadu na výšku, nám pomáha zlepšovať životy ľudí, ktorí to potrebujú.</p>
        </section>
