...
<div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6 md:px-12 pb-12">
        ...
        <div class="max-w-lg">
            <h2 class="text-4xl md:text-5xl font-extrabold leading-tight">
                Spolu je život <span class="text-blue-300">veselší</span>
            </h2>
            ...
            <div class="mt-8 flex gap-4 flex-wrap">
                <a href="#about"
                   class="inline-flex items-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-400 text-white font-medium rounded-lg shadow transition">
                    <span>More about us</span>
                </a>
                <a href="https://facebook.com"
                   class="inline-flex items-center gap-2 px-6 py-3 border border-blue-400 text-blue-100 hover:bg-blue-800 hover:text-white rounded-lg transition">
                    <!-- Facebook Icon -->
